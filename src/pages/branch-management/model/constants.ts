...
export const BRANCH_CREATE_STATUS_VALUES: BranchStatus[] = [
  "ACTIVE",
  "INACTIVE",
];

export const BRANCH_ACTION_MENU_CLASS =
  "w-48 rounded-lg [zoom:var(--app-scale)]";
export const BRANCH_STATUS_SUB_MENU_CLASS =
